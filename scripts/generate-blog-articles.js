...
const FALLBACK_OG =
  "https://www.artisanscloud.com/assets/og/articles-and-resources.png";
...
function generateHtml(meta, slug, bodyHtml) {
  ...
  const ogImage =
    meta.hero && meta.hero.startsWith("http") ? meta.hero : FALLBACK_OG;
  ...
  parts.push(
    '  <link rel="shortcut icon" href="/assets/image/favicon_io/favicon.ico" type="image/x-icon">',
  );
  parts.push(
  ...
  parts.push(`  <meta name="theme-color" content="${BRAND.primary}">`);
  parts.push("");
  ...
  const paddingBottomClass = hero
    ? "pb-20 sm:pb-24 md:pb-[200px] lg:pb-[350px]"
    : "pb-20 sm:pb-24";

  parts.push("  <!-- Hero section -->");
  parts.push('  <section class="w-full h-full p-4 lg:p-5">');
  parts.push(
    '    <div class="pt-[clamp(7rem,16.667vw-5rem,7.5rem)] min-h-full ' +
      minHeightClass +
      " h-full rounded-2xl lg:rounded-[30px] px-3 overflow-hidden bg-[url('/assets/image/blog-list/bloge-detail-banner.webp')] bg-no-repeat bg-cover\">",
  );
  parts.push(
    '      <div class="max-w-[850px] w-full mx-auto mt-[50px] ' +
      paddingBottomClass +
      '">',
  );
  ...
  parts.push(
    '            <a href="/articles-and-resources" class="sm:text-base text-sm text-description font-normal font-primary hover:text-heading transition-colors">Resources</a>',
  );
  parts.push(
    '            <span class="sm:text-base text-sm text-description font-normal font-primary">',
  );
  parts.push("              " + CHEVRON_SVG);
  parts.push("            </span>");
  parts.push(
    '            <span class="sm:text-base text-sm text-heading font-normal font-primary">' +
      title +
      "</span>",
  );
  parts.push("          </div>");
  ...
  parts.push("");
  parts.push(
    '        <h1 class="mb-3.5 font-primary font-semibold text-2xl sm:text-4xl lg:text-[44px] xl:text-[50px] text-heading leading-[120%]">' +
      title +
      "</h1>",
  );
  parts.push("");
  ...
  parts.push(
    '        <div class="mb-4 sm:mb-5 flex flex-wrap gap-2 items-center">',
  );
  parts.push("          " + buildTagsHtml(tags));
  if (dateStr) {
    parts.push(
      '          <div class="relative ps-3 text-description/70 lg:text-base text-sm font-normal font-primary">',
    );
    parts.push(
      '            <div class="absolute top-2.5 start-0 bg-description/70 h-1 w-1 rounded-full"></div>',
    );
  ...
  parts.push(
    '          <div class="max-w-[53px] min-w-[53px] h-[53px] grid place-items-center bg-[#FFFFFF] rounded-full">',
  );
  parts.push("            " + LOGO_SVG);
  parts.push("          </div>");
  parts.push("          <div>");
  parts.push(
    '            <div class="sm:text-base text-sm font-medium font-primary text-heading">Artisans Cloud</div>',
  );
  parts.push(
    '            <div class="sm:text-base text-sm font-normal font-primary text-description">Architects of the intelligence enterprise | Unifying Data, AI &amp; Commerce</div>',
  );
  parts.push("          </div>");
  parts.push("        </div>");
  parts.push("      </div>");
  ...
  if (hero) {
    ...
    parts.push(
      '  <div class="fade-in relative z-[2] mx-auto mb-[50px] -mt-[13%] sm:-mt-[14%] md:-mt-[150px] lg:-mt-[300px] w-[80%] max-w-[850px] aspect-[2/1] overflow-hidden rounded-[12px]">',
    );
    parts.push(
      '    <img src="' +
        hero +
        '" alt="' +
        heroAlt.replace(/"/g, "&quot;") +
        '" width="1200" height="600" class="h-full w-full object-cover object-top">',
    );
    parts.push("  </div>");
    parts.push("");
  }
  ...
  parts.push("  </div>");
  parts.push("");
  parts.push("  <!-- Latest Insights -->");
  parts.push('  <section class="lg:py-[100px] sm:py-16 py-10">');
  parts.push('    <div class="max-w-[1240px] w-full px-4 xl:px-0 mx-auto">');
  parts.push(
    '      <div class="fade-in lg:mb-10 mb-7 flex items-center gap-5 justify-between flex-nowrap">',
  );
  parts.push(
    '        <div class="lg:text-5xl md:text-4xl text-3xl text-heading font-primary font-semibold leading-[120%]">Latest Insights</div>',
  );
  parts.push(
    '        <div class="flex items-center justify-center gap-[clamp(0.5rem,1.111vw+0.167rem,1rem)]">',
  );
  parts.push(
    '          <div class="swiper-button-prev swiper-button-prev-latestInsightsSlider after:hidden !static border border-heading rounded-full !w-8 !h-8 !m-0 transition-all duration-200 ease-linear cursor-pointer">',
  );
  parts.push(
    '            <img src="/assets/image/icon/rightArrowSwiper.svg" alt="Previous slide arrow" width="24" height="24" loading="lazy" class="h-[70%] select-none rotate-180">',
  );
  parts.push("          </div>");
  parts.push(
    '          <div class="swiper-button-next swiper-button-next-latestInsightsSlider after:hidden !static border border-heading rounded-full !w-8 !h-8 !m-0 transition-all duration-200 ease-linear cursor-pointer">',
  );
  parts.push(
    '            <img src="/assets/image/icon/rightArrowSwiper.svg" alt="Next slide arrow" width="24" height="24" loading="lazy" class="h-[70%] select-none">',
  );
  parts.push("          </div>");
  parts.push("        </div>");
  parts.push("      </div>");
  parts.push('      <div class="swiper latestInsightsSlider">');
  parts.push(
    '        <div class="swiper-wrapper" id="latest-insights-grid" data-current-url="/blog/' +
      slug +
      '"></div>',
  );
  parts.push("      </div>");
...
function main() {
  ...
  if (!existsSync(BLOG_DIR)) {
    console.log(
      "blog/ directory does not exist yet. Writing empty local-articles.json.",
    );
    writeFileSync(LOCAL_ARTICLES_PATH, "[]\n", "utf-8");
    return;
  }
  ...
  if (mdFiles.length === 0) {
    ...
    if (existsSync(LOCAL_ARTICLES_PATH)) {
      ...
      if (existing && existing.trim() !== "[]") {
        console.log(
          "No .md files found in blog/. Keeping existing local-articles.json.",
        );
        return;
      }
    }
    console.log(
      "No .md files found in blog/. Writing empty local-articles.json.",
    );
    writeFileSync(LOCAL_ARTICLES_PATH, "[]\n", "utf-8");
    return;
  }
  ...
  if (!targetSlug) {
    ...
    console.log(
      "Written: assets/data/local-articles.json (" +
        articles.length +
        " articles)",
    );
  } else {

...
function generateHtml(meta, slug, bodyHtml) {
  ...
  parts.push('        <div class="lg:text-5xl md:text-4xl text-3xl text-heading font-primary font-semibold leading-[120%]">Latest Insights</div>');
  parts.push('        <div class="flex items-center justify-center gap-[clamp(0.5rem,1.111vw+0.167rem,1rem)]">');
  parts.push('          <div class="swiper-button-prev swiper-button-prev-latestInsightsSlider after:hidden !static border border-heading rounded-full !w-8 !h-8 !m-0 transition-all duration-200 ease-linear cursor-pointer">');
  ...
  parts.push('          </div>');
  parts.push('          <div class="swiper-button-next swiper-button-next-latestInsightsSlider after:hidden !static border border-heading rounded-full !w-8 !h-8 !m-0 transition-all duration-200 ease-linear cursor-pointer">');
  ...
  parts.push('        <div class="swiper-wrapper" id="latest-insights-grid" data-current-url="/blog/' + slug + '"></div>');
  parts.push('      </div>');
  parts.push('    </div>');
  parts.push('  </section>');
  parts.push('');

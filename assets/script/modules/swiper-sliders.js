...
export function initSwipers() {
  ...
  const modulesBusinessImpactSliderEl = document.querySelector(
    ".ModulesBusinessImpactSlider",
  );
  ...
  const nexusCapabilitySliderEl = document.querySelector(
    ".nexusCapabilitySlider",
  );
  ...
  const dynamicPricingSliderEl = document.querySelector(
  ...
  const personalizedCXExperienceSliderEl = document.querySelector(
    ".PersonalizedCXExperienceSlider",
  );
  ...
  const personalizedRecsSliderEl = document.querySelector(
    ".PersonalizedRecsSlider",
  );

...
**Key files**:
- **Templates**: `index.html`, `retail-platform.html`, `data-intelligence.html`, `enterprise-ai.html`, `dify-consulting.html`, `smarter-inventory-alerts.html` + solution/blog pages

...
**Key files**:
- **Templates**: `index.html`, `nexus-unified-commerce.html`, `data-intelligence.html`, `enterprise-ai.html`, `dify-consulting.html` + nested pages (e.g. `enterprise-copilot/lumen.html`) + solution/blog pages

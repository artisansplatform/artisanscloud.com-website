...
**Key files**:
- **Templates**: `index.html`, `unified-commerce.html`, `data-intelligence.html`, `enterprise-ai.html`, `dify-consulting.html` + solution/blog pages
...
- **Links**: Use root-relative paths: `/index`, `/unified-commerce`, `/data-intelligence`

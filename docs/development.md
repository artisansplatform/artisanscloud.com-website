...
| Docs             | `tests/docs.test.js`            | broken markdown tables (tracked and untracked files): a row split from its table by a blank line, or a table with no header separator row                                                                                     |

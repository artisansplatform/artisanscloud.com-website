...
| Conventions      | `tests/conventions.test.js`     | inline executable scripts, duplicate Swiper selectors, broken/ shadowing redirects, redirect stubs left in the sitemap, em dashes in tracked files, shell-string child processes, POSIX-only npm scripts                      |
